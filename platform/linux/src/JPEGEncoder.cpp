...
void jpeg_mem_dst( j_compress_ptr cinfo, jpeg_destination_mem_mgr * dst )
{
...
NV21ToJpegEncoder::NV21ToJpegEncoder(const int width, const int height,
									const int quality)
...
YUY2ToJpegEncoder::YUY2ToJpegEncoder(const int width, const int height,
										const int quality)
: YuvToJpegEncoder(width, height, quality)
{
